# Copied from https://github.com/huggingface/lerobot/blob/f0d2b37b/src/lerobot/policies/pi05/modeling_pi05.py
...
from flagscale.models.pi05.pi_gemma import (
...
class PI05Policy(TrainablePolicy):
    ...
    def fsdp_units(self):
        pwe = self.model.paligemma_with_expert
        units = []
        units.append(pwe.paligemma.model.vision_tower)
        units.append(pwe.paligemma.model.multi_modal_projector)
        for layer in pwe.paligemma.model.language_model.layers:
            units.append(layer)
        for layer in pwe.gemma_expert.model.layers:
            units.append(layer)
        return units
