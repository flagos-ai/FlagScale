...
from .gpt2_tokenization import AquilaTokenizer, GPT2Tokenizer
...
def build_tokenizer(args, **kwargs):
    ...
    if args.tokenizer_type == 'BertWordPieceLowerCase':
        ...
        tokenizer = _AquilaTokenizerFS(args.vocab_file, args.merge_file, args.special_tokens_file)
...
class _Qwen2VLTokenizer(MegatronLegacyTokenizer):
    def __init__(self, tokenizer_path, extra_vocab_size):
        ...
        self.processor = AutoProcessor.from_pretrained(tokenizer_path, revision="main", token=None)
