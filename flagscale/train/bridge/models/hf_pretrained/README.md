...
Structured, type-safe classes for working with Hugging Face checkpoints. Each checkpoint type has its own structure - `flagscale.train.bridge.models.hf_pretrained` makes these contracts explicit and provides a clean interface.

## Quick Start

```python
from flagscale.train.bridge.models.hf_pretrained import PreTrainedCausalLM
...
```python
from flagscale.train.bridge.models.hf_pretrained import PreTrainedVLM
